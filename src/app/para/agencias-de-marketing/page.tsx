  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "El plan Pro incluye hasta 10 landings activas y el plan Unlimited es 100% ilimitado. Cambia la URL de tu cliente y la IA genera una landing nueva en 30 segundos." },
    },
    {
      "@type": "Question",
      name: "¿Puedo eliminar la marca de LandForge y usar la mía propia?",
      acceptedAnswer: { "@type": "Answer", text: "Sí, con el plan Unlimited activas el White Label completo. Tu cliente ve tu marca y tu dominio en todas las pantallas, sin ninguna mención a LandForge." },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "El plan Unlimited incluye hasta 5 puestos de usuario, ideal para equipos con diseñador, trafficker y account manager trabajando al mismo tiempo." },
    },
  ],
};
        ...
        <main>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="flex flex-col gap-10">
                {[
                  ...
                  { num: "04", title: "Entregas con tu White Label", text: "Activa el White Label del plan Unlimited: tu logo, tu dominio, tu panel de cliente. El cliente ve tu marca en todo momento. LandForge trabaja entre bastidores sin aparecer en ningún sitio.", badge: "Invisible para tu cliente" },
                ].map((step) => (
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  { title: "Coste por landing (LandForge Unlimited)", value: "~3€", sub: "97€/mes ÷ 30 landings = 3.23€ c/u", color: "#9D4EDD" },
          ...
          <section className="px-6 py-24 bg-[#F3E8FF]">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="divide-y divide-[#E0AAFF]">
                {[
                  { q: "¿Cuántas landings puedo generar para mis clientes?", a: "El plan Pro incluye hasta 10 landings activas y el plan Unlimited es 100% ilimitado. Cambia la URL de tu cliente y la IA genera una landing nueva en 30 segundos." },
                  { q: "¿Puedo eliminar la marca de LandForge y usar la mía propia?", a: "Sí, con el plan Unlimited activas el White Label completo. Tu cliente ve tu marca y tu dominio en todas las pantallas, sin ninguna mención a LandForge." },
                  ...
                  { q: "¿Cuántos usuarios de mi equipo pueden acceder?", a: "El plan Unlimited incluye hasta 5 puestos de usuario, ideal para equipos con diseñador, trafficker y account manager." },
                ].map((faq) => (
          ...
          <section className="px-6 py-24 text-center" style={{ background: "linear-gradient(135deg, #9D4EDD 0%, #4C0099 100%)" }}>
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-[#E0AAFF] text-lg mb-10">Tu próximo cliente podría ver una landing de su negocio en la misma reunión de firma. Sin esperas, sin diseñador bloqueado, sin coste de producción.</p>
              ...
              <p className="text-[#E0AAFF] mt-5 text-sm">Sin tarjeta · White Label disponible · 5 usuarios en el plan Unlimited</p>
            </div>
          </section>
