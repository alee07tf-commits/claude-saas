        ...
        <main>
          ...
          <section id="demo" className="px-6 py-24 bg-white">
            <div className="max-w-5xl mx-auto">
              ...
              {/* Video demo */}
              <div className="mb-16 mx-auto" style={{ maxWidth: "800px", borderRadius: "16px", overflow: "hidden", border: "1px solid #E0AAFF", boxShadow: "0 24px 64px rgba(157,78,221,0.14)", position: "relative", paddingBottom: "56.25%", height: 0, background: "#000" }}>
                <iframe
